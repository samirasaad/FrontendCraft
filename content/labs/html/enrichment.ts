...
import type { LegacyLesson } from "@/content/labs/_legacy";
import { defaultInsights } from "@/content/labs/_insights";
import { htmlMediumExamples } from "@/content/labs/html/legacy-example-tiers";
import { htmlInsights } from "@/content/labs/html/insights";
import { DEMO_VIDEO_MP4 } from "@/lib/demo-assets";
import type {
  CodeExample,
  Lesson,
  LocalizedString,
  ...
  return {
    ...
    content: {
      ...
      examples: [
        ...
        htmlMediumExamples[lesson.slug] ??
          mediumExample(
            lesson.content.code,
            lesson.content.expectedOutput.en,
            lesson.content.expectedOutput.ar,
