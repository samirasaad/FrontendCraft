...
export const ui = {
  ...
  levelQuizReplay: { en: "Replay quiz", ar: "أعد الاختبار" },
  levelQuizContinue: { en: "Next question", ar: "السؤال التالي" },
  levelQuizFinish: { en: "See results", ar: "شوف النتيجة" },
  levelQuizAnswerRevealed: { en: "Answer revealed", ar: "الإجابة اتظهرت" },
  levelQuizMissedTitle: { en: "Review what you missed", ar: "راجع اللي فاتتك" },
  levelQuizMissedEmpty: {
    en: "You got every question — nice.",
    ar: "جاوبت على كل الأسئلة — تمام.",
  },
  levelQuizScoreDetail: {
    en: "{score} of {total} correct · {percent}%",
    ar: "{score} من {total} صح · {percent}%",
  },
  levelQuizPairSelectLeft: {
    en: "Tap a left item, then match it on the right.",
    ar: "اضغط عنصر من الشمال، وبعدين طابقه من اليمين.",
  },
  levelQuizPairMatched: { en: "Matched", ar: "متطابق" },
  levelQuizConsolePlaceholder: { en: "Type the answer…", ar: "اكتب الإجابة…" },
  levelQuizFillPlaceholder: { en: "…", ar: "…" },
