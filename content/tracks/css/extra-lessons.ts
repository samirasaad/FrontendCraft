...
<nav class="menu"><a href="#learn">Learn</a><a href="#practice">Practice</a></nav>`,
      ...
      visualHint: L(
        ...
        "قارن القاعدة الحمرا بالخضرا، وبعدين افحص النتيجة المحسوبة.",
      ),
      pitfalls: [
        pitfall(
          ...
          `* { box-sizing: border-box; }\n.card { width: 300px; padding: 24px; border: 4px solid; }`,
          L("border-box includes padding and border in the width.", "border-box بتضم padding وborder جوه الـ width."),
  ...
  },
  {
    ...
    content: {
      ...
      summary: L(
        ...
        "انسخ أنماط عملية مختصرة للـ layout والمقاسات وtheme tokens والحركة.",
      ),
      paragraphs: [
        L("Use the cards as a recall tool, not a replacement for understanding the cascade and layout algorithms.", "استخدم الكروت كأداة تذكّر، مش بديل عن فهم cascade وlayout algorithms."),
