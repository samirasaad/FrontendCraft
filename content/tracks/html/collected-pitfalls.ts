...
<main>...</main>`,
    ...
    L("Semantic landmarks", "Semantic landmarks"),
  ),
  pitfall(
  ...
  pitfall(
    ...
    L("Accessibility controls", "Accessibility controls"),
  ),
  pitfall(
  ...
  pitfall(
    ...
    L("Buttons vs links", "Buttons vs links"),
  ),
  pitfall(
    `<p><div>card</div></p>`,
    ...
    L("Invalid nesting", "Invalid nesting"),
  ),
];
